 ...
 */
@Named(value = "milestoneTaskConverter")
@Dependent
public class MilestoneTaskConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.trim().equals("")) {
            ...
            try {
                ...
                for (Milestone m : taskViewBean.getHistorySelected().getMilestones()) {
                    if (m.getId() == numero) {
                        return m;
                    }
                }            
